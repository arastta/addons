...
<head>
    ...
    <link href="catalog/view/theme/clothy/stylesheet/stylesheet.css" rel="stylesheet">
    <link href="catalog/view/theme/clothy/stylesheet/custom.css" rel="stylesheet">
            ...
            <div class="col-sm-9">
                <nav id="menu" class="navbar pull-right">
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-navsearch" data-toggle="modal" data-target="#navsearch"><span class="fa fa-search"></span></button>
                        <!-- Modal -->
                        <div class="modal fade" id="navsearch" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
