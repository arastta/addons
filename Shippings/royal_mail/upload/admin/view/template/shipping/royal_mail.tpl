    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" onclick="save('save')" form="form-royal-mail" data-toggle="tooltip" title="" class="btn btn-success" data-original-title="Save">
                    <i class="fa fa-check"></i></button>
                <button type="submit" form="form-royal-mail" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Save & Close">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li>
                                    <a href="#tab-special-delivery-500" data-toggle="tab"><?php echo $tab_special_delivery_500; ?></a>
                                </li>
                                <li>
                                    <a href="#tab-special-delivery-1000" data-toggle="tab"><?php echo $tab_special_delivery_1000; ?></a>
                                </li>
                                <li>
                                    <a href="#tab-special-delivery-2500" data-toggle="tab"><?php echo $tab_special_delivery_2500; ?></a>
                                </li>
                                <li>
                                    <a href="#tab-1st-class-signed" data-toggle="tab"><?php echo $tab_1st_class_signed; ?></a>
                                </li>
                                <li>
                                    <a href="#tab-2nd-class-signed" data-toggle="tab"><?php echo $tab_2nd_class_signed; ?></a>
                                </li>
                                <li>
                                    <a href="#tab-1st-class-standard" data-toggle="tab"><?php echo $tab_1st_class_standard; ?></a>
                                </li>
                                <li>
                                    <a href="#tab-2nd-class-standard" data-toggle="tab"><?php echo $tab_2nd_class_standard; ?></a>
                                </li>
                                <li>
                                    <a href="#tab-international-standard" data-toggle="tab"><?php echo $tab_international_standard; ?></a>
                                </li>
                                <li>
                                    <a href="#tab-international-tracked-signed" data-toggle="tab"><?php echo $tab_international_tracked_signed; ?></a>
                                </li>
                                <li>
                                    <a href="#tab-international-tracked" data-toggle="tab"><?php echo $tab_international_tracked; ?></a>
                                </li>
                                <li>
                                    <a href="#tab-international-signed" data-toggle="tab"><?php echo $tab_international_signed; ?></a>
                                </li>
                                <li>
                                    <a href="#tab-international-economy" data-toggle="tab"><?php echo $tab_international_economy; ?></a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-sm-10">
