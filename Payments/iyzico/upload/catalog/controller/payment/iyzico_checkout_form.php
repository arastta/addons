...
class ControllerPaymentIyzicoCheckoutForm extends Controller
{
    ...
    public function index()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/iyzico_checkout_form.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/template/payment/iyzico_checkout_form.tpl', $data);
        } else {
            return $this->load->view('default/template/payment/iyzico_checkout_form.tpl', $data);
        }
    }
    ...
    public function gettoken()
    {
        ...
        try {
            ...
            $request->setPaymentSource('ARASTTA');
    ...
    public function error() {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/error/not_found.tpl')) {
            $template_url = $this->config->get('config_template') . '/template/error/not_found.tpl';
        } else {
