...
$_['transaction_declined_text']   = 'Bizimle alışveriş için teşekkür ederiz. Ancak, işlem reddedildi.';
$_['order_already_exists']        = 'Sipariş zaten var';
$_['invalid_order']               = 'Geçersiz sipariş';
$_['invalid_request']             = 'Geçersiz istek';
$_['heading_title']               = 'Aradığınız sayfa bulunamadı!';
$_['text_error']                  = 'Aradığınız sayfa bulunamadı!';
$_['error_invalid_currency']      = 'Şu anda sadece TL desteklenmektedir.';
$_['button_confirm']              = "Onaylamak";