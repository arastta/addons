...
class ModelPaymentIyzicoCheckoutInstallment extends Model
{
    ...
    {
        $this->db->query("CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "iyzico_order` (
        ...
        $this->db->query("CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "iyzico_order_refunds` (
    ...
    {
        $log = new Log('iyzico_checkout_installment.log');
