    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" onclick="save('save')" form="form-securetrading-pp" data-toggle="tooltip" title="" class="btn btn-success" data-original-title="Save">
                    <i class="fa fa-check"></i></button>
                <button type="submit" form="form-securetrading-pp" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Save & Close">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-securetrading-pp" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="securetrading_pp_site_security_status" id="securetrading_pp_site_security_status" class="form-control">
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="securetrading_pp_site_notification_password"><?php echo $entry_notification_password; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="securetrading_pp_notification_password" value="<?php echo $securetrading_pp_notification_password; ?>" placeholder="<?php echo $entry_notification_password; ?>" id="securetrading_pp_site_notification_password" class="form-control"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="securetrading_pp_webservice_password" value="<?php echo $securetrading_pp_webservice_password; ?>" placeholder="<?php echo $entry_password; ?>" id="securetrading_pp_webservice_password" class="form-control"/>
