    ...
    <fieldset id="payment">
        ...
        <div class="form-group">
            <div class="col-sm-12">
                ...
                <ul>
                    <?php if ($accepted_cards['mastercard'] == 1) { ?>
                    <li><?php echo $text_card_type_m; ?></li>
                    <?php } ?>
                    <?php if ($accepted_cards['visa'] == 1) { ?>
                    <li><?php echo $text_card_type_v; ?></li>
                    <?php } ?>
                    <?php if ($accepted_cards['diners'] == 1) { ?>
                    <li><?php echo $text_card_type_c; ?></li>
                    <?php } ?>
                    <?php if ($accepted_cards['amex'] == 1) { ?>
                    <li><?php echo $text_card_type_a; ?></li>
                    <?php } ?>
                    <?php if ($accepted_cards['maestro'] == 1) { ?>
                    <li><?php echo $text_card_type_ma; ?></li>
                    <?php } ?>
                </ul>
                </p>
            </div>
        ...
        <div class="form-group">
            <div class="col-sm-12">
                ...
                <p>
                    <input type="radio" name="cc_choice" value="<?php echo $card['token']; ?>" class="stored_card" <?php echo $i == 0 ? 'checked="checked"' : ''; ?>/> <?php echo $card['card_type'] . ' xxxx ' . $card['digits'] . ', ' . $entry_cc_expire_date . ' ' . $card['expire_month'] . '/' . $card['expire_year']; ?>
                </p>
                <?php $i++; ?>
                <?php } ?>
        ...
        <div id="card_info" style="display:none;">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="hidden" name="cc_store" value="0"/>
                    <input type="checkbox" name="cc_store" value="1" checked/>
                </div>
            </div>
            <?php } ?>
        </div>
