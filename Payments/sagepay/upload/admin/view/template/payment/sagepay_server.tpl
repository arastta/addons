    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" onclick="save('save')" form="form-sagepay-server" data-toggle="tooltip" title="" class="btn btn-success" data-original-title="Save">
                    <i class="fa fa-check"></i></button>
                <button type="submit" form="form-sagepay-server" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Save & Close">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-sagepay-server" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10"><span id="cron-job-url"><?php echo $sagepay_server_cron_job_url ?></span>
                        </div>
                    </div>
                    <div class="form-group">
