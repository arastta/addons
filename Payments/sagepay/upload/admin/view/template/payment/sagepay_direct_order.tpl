...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td id="release_status"><?php if ($sagepay_direct_order['release_status'] == 1) { ?>
            ...
            <a class="button btn btn-primary" id="button-release"><?php echo $button_release; ?></a>
    ...
    <tr>
        ...
        <td>
            <table class="table table-striped table-bordered" id="sagepay_direct_transactions">
                <thead>
                <tr>
