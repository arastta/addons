...
class ModelPaymentSagePayServer extends Model
{
    ...
    protected function setPaymentData($order_info, $sagepay_order_info, $price, $order_recurring_id, $recurring_name, $i = null)
    {
    ...
    protected function calculateSchedule($frequency, $next_payment, $cycle)
    {
    ...
    protected function addRecurringOrder($order_id, $response_data, $order_recurring_id, $trial_end, $subscription_end)
    {
    ...
    protected function updateRecurringOrder($order_recurring_id, $next_payment)
    {
    ...
    protected function getRecurringOrder($order_recurring_id)
    {
    ...
    protected function addRecurringTransaction($order_recurring_id, $response_data, $type)
    {
    ...
    protected function getProfile($order_recurring_id)
    {
