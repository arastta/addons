...
class ControllerPaymentPPExpress extends Controller
{
    ...
    public function recurringButtons()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/buttons.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/template/payment/buttons.tpl', $data);
        } else {
            return $this->load->view('default/template/payment/buttons.tpl', $data);
        }
    }
}
