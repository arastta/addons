    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a onclick="editSearch();" id="button-edit" data-toggle="tooltip" style="display:none;" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                <a onclick="doSearch();" id="button-search" data-toggle="tooltip" title="<?php echo $button_search; ?>" class="btn btn-info"><i class="fa fa-search"></i></a>
            </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div id="search-box" style="display:none;">
                    <div id="searching">
                        <i class="fa fa-circle-o-notch fa-spin fa-lg"></i> <?php echo $text_searching; ?></div>
