...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td><?php echo $paypal_order['total']; ?>
            ...
            &nbsp;&nbsp;
            <a onclick="doVoid();" class="button paypal_capture btn btn-primary" id="button-void"><?php echo $button_void; ?></a>
    ...
    <tr class="paypal_capture">
        ...
        <td><p>
            ...
            <p>
                ...
                <a class="btn btn-primary" onclick="capture();" id="button_capture"><?php echo $button_capture; ?></a>
