    ...
    public static function parseOrderItems($data){
        ...
        while(isset($data[sprintf(self::FORMAT_STRING, $i, "description")]))
        {
            $items[$i] = new OrderItem(
                    isset($data[sprintf(self::FORMAT_STRING, $i, "description")])?$data[sprintf(self::FORMAT_STRING, $i, "description")]:0,
                    isset($data[sprintf(self::FORMAT_STRING, $i, "unitPrice")])?$data[sprintf(self::FORMAT_STRING, $i, "unitPrice")]:0,
                    isset($data[sprintf(self::FORMAT_STRING, $i, "quantity")])?$data[sprintf(self::FORMAT_STRING, $i, "quantity")]:0,
                    isset($data[sprintf(self::FORMAT_STRING, $i, "taxPercentage")])?$data[sprintf(self::FORMAT_STRING, $i, "taxPercentage")]:0,
                    isset($data[sprintf(self::FORMAT_STRING, $i, "sku")])?$data[sprintf(self::FORMAT_STRING, $i, "sku")]:0
            );
