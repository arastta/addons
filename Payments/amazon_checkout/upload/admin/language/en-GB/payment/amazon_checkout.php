...
$_['text_amazon_checkout'] = '<a onclick="window.open(\'http://go.amazonservices.com/UKCBASPArastta.html\');"><img src="view/image/payment/amazon.png" alt="Amazon Payments" title="Amazon Payments" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_amazon_join']     = 'To create your Amazon Payments account <a href="http://go.amazonservices.com/UKCBASPArastta.html" target="_blank" title="Click here to join Amazon Payments" class="alert-link">click here.</a>';
