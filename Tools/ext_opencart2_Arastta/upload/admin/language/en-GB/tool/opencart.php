<?php
// Heading
$_['heading_title']    = 'Opencart 2 Migration';

// Text
$_['text_backup']      = 'Download Backup';
$_['text_success']     = 'Success: You have successfully imported your database!';
$_['text_list']        = 'Upload List';
$_['text_create_dbtable'] = 'Install Opencart DataBase Tables';
$_['text_create_migration'] = 'Migration Opencart to Arastta!';
$_['text_remove'] = 'Remove Opencart Database file and tables';
...
// Help
$_['help_upload']      = 'Only Sql extension files. ( Ex: opencart.sql )';
